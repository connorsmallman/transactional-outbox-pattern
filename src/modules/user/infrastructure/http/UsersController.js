...
var UsersController = /** @class */ (function () {
    function UsersController(createUserUseCase, getUserUseCase) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.createUserUseCase.execute({
                                name: body.name,
                                email: body.email,
    ...
    UsersController.prototype.getUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getUserUseCase.execute(id)()];
                    case 1:
                        response = _a.sent();
                        if (fp_ts_1.either.isLeft(response)) {
                            throw new Error(response.left.message);
